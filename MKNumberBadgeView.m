...
-(CGSize)getSizeOfFont:(UIFont*)aFont text:(NSString*)aStr
{
...
- (void)drawRect:(CGRect)rect
{
	...
	CGSize numberSize = [self getSizeOfFont:self.font text:numberString];
	...
	[numberString drawAtPoint:textPt withAttributes:tdic];
