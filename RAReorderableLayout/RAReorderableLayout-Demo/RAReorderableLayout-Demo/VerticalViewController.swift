...
class VerticalViewController: UIViewController, RAReorderableLayoutDelegate, RAReorderableLayoutDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.registerNib(UINib(nibName: "JFCollectionHeadViewCollection", bundle: nil), forSupplementaryViewOfKind: UICollectionElementKindSectionHeader, withReuseIdentifier: "JFCollectionHeadViewCollection");
         self.collectionView.registerNib(UINib(nibName: "JFFooterCollectionReusableView", bundle: nil), forSupplementaryViewOfKind: UICollectionElementKindSectionFooter, withReuseIdentifier: "JFFooterCollectionReusableView");
    ...
    func collectionView(collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, atIndexPath indexPath: NSIndexPath) -> UICollectionReusableView {
        var resuabeleView:UICollectionReusableView!;
        if(kind == UICollectionElementKindSectionHeader)
        {
            let headView = collectionView.dequeueReusableSupplementaryViewOfKind(UICollectionElementKindSectionHeader, withReuseIdentifier: "JFCollectionHeadViewCollection", forIndexPath: indexPath) as? JFCollectionHeadViewCollection;
            //headView!.labelTitle.text = "dejyfawefyrea";
            headView?.backgroundColor = UIColor.redColor();
            resuabeleView = headView!;
        }else
        {
            
            let footView = collectionView.dequeueReusableSupplementaryViewOfKind(UICollectionElementKindSectionFooter, withReuseIdentifier: "JFFooterCollectionReusableView", forIndexPath: indexPath) as? JFFooterCollectionReusableView;
            resuabeleView = footView!;
            
        }
        
        
        
        return resuabeleView;
    }
